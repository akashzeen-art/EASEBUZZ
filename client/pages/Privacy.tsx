        ...
        <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white/10 backdrop-blur-md rounded-xl p-8 text-white">
            ...
            <div className="space-y-6 text-sm leading-relaxed">
              <p>This Privacy Policy describes how Alphamovil Digital Solution LLP ("we", "us", or "our") collects, uses, discloses, and protects your personal information when you visit or use https://E-Yoga Studio.com/ (the "Site") or any of our services (collectively, the "Services").</p>
              ...
              <h3 className="text-lg font-semibold mt-4 mb-2">c) Third-Party Sources</h3>
              <ul className="list-disc pl-6 space-y-2">
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">5. Content Validity and Access Terms</h2>
              <p>E-Yoga Studio is a Video-on-Demand (VOD) yoga subscription service. Access to content is granted upon successful subscription to one of the following plans:</p>
              <ul className="list-disc pl-6 space-y-2 mt-2">
                <li>Weekly Plan — 7 days of full access to all yoga content on the platform</li>
                <li>Monthly Plan — 30 days of full access to all yoga content on the platform</li>
                <li>Quarterly Plan — 90 days of full access to all yoga content on the platform</li>
              </ul>
              <p className="mt-4">Access to content is valid only for the duration of the active subscription period. Upon expiry, access will be revoked until the subscription is renewed. E-Yoga Studio reserves the right to modify, update, or remove content from the platform at any time without prior notice.</p>

              <h2 className="text-2xl font-bold mt-8 mb-4">6. Usage Restrictions</h2>
              ...
              <p>Our Services are not intended for users under the age of 16. We do not knowingly collect personal data from children. If you believe a child has submitted personal information through our platform, please contact us immediately at bd@alphamovil.com and we will take prompt steps to delete such information from our records.</p>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">8. External Links</h2>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4">9. Security and Retention</h2>
              ...
              <p className="mt-4">By participating in these classes, you acknowledge that you do so voluntarily and at your own risk. The platform and its instructors shall not be held responsible for any injuries, damages, or losses that may occur as a result of using this content. Individual results may vary.</p>
              ...
              <p className="mt-2">📧 bd@alphamovil.com</p>
              <p className="mt-1">📍 Alphamovil Digital Solution LLP, Sector 54, Gurgaon, Haryana, 122011</p>
